...
import { FaEnvelope, FaUser, FaLock, FaArrowRight, FaCheckCircle } from 'react-icons/fa';
...
const AdminSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('[AdminSignup] Registration error:', err);
      setError(err.response?.data?.msg || 'Admin registration failed. Please try again.');
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mb-4">
                ...
                <AnimatePresence>
                  {success && (
                    ...
                    >
                      <FaCheckCircle />
                      <span>Admin signup successful! Redirecting...</span>
                    </motion.div>
                  )}
                </AnimatePresence>
                <button
                ...
                >
                  <span>{isLoading ? 'Signing Up...' : 'Sign Up as Admin'}</span>
                </button>
              </form>
              <div
